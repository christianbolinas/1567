...
1. Merge overlapped blobs. I think I did this, but I didn't use Dr. Tan's algorithm.
2. Make robot turn towards object at constant speed (linear.x = 0.0, angular.z = 0.1). 

    This angular.z value results in no movement. It works as expected if we use angular.z = 1. See TURN_SPEED.

3. Modify program to eliminate false blob detection. 
'''

# ---------- CONFIG ---------- #
TOL_DEG = 45
TURN_SPEED = 1
ONLY_USE_BIGGEST_BLOB = True
