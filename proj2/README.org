...
The equation for the =angular.z= is:
    ...
    z(t) = K_p * e(t) + K_i * \int_0^t [ e(t)dt ] + K_d \frac{de}{dt}

Where:

    - K_p, K_i, and K_d are all constants of proportionality for P, I, and D (respectively, duh); they're set (tuned)
      manually
...
while not rospy.is_shutdown():
    ...
    # --- THIS IS THE CALCULATION OF z(t) FOR PID DON'T TWEAK ON ME ---
    curr_time = time()
